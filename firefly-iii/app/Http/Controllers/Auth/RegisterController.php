...
final class RegisterController extends Controller
{
    ...
    public function register(Request $request): RedirectResponse
    {
        ...
        if (false === $allowRegistration && false === $validCode) {
            throw new FireflyException((string) trans('firefly.registration_unavailable'));
        }
    ...
    public function showInviteForm(Request $request, string $code): Factory|\Illuminate\Contracts\View\View
    {
        ...
        if ($allowRegistration) {
            $message = (string) trans('firefly.invite_code_not_required');

            return view('errors.error', ['message' => $message]);
        }
        if (false === $validCode) {
            $message = (string) trans('firefly.invalid_invite_code');
    ...
    public function showRegistrationForm(?Request $request = null): Factory|\Illuminate\Contracts\View\View
    {
        ...
        if (false === $allowRegistration) {
            $message = (string) trans('firefly.registration_unavailable_admin');
